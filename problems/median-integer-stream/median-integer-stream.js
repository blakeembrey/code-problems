...
module.exports = function () {
  return {
    insert: function (number) {
      ...
      // If the left nodes are larger than the right nodes, move the median pointer
    ...
    getMedian: function () {
      // If the left and right node counts are identical, we can return the value exactly
      if (this._left === this._right) { return this._median.value; }
