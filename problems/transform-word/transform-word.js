module.exports = function (dictionary, start, end) {
  ...
  var createGraph = function (dictionary) {
    ...
    dictionary.forEach(function (word) {
      // Add the word to the graph structure with an array for the connecting nodes
      graph[word] = [];
  ...
  (function findRoute (word, route) {
    // If the word doesn't exist in the graph or we have gone to the word before, break
    ...
    if (word === end) { return shortestRoute = route; }
